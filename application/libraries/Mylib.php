...
class Mylib
{
    ...
    function db_get_multiple_rows($sql)
    {
    ...
    function db_get_single_row($sql)
    {
        $query = $this->CI->db->query($sql);
    ...
    function date_get_current_time()
    {
        return date('H:i:s');
    }

    function date_set_time_format($time)
    {
        return date('h:i A', strtotime($time));
    }

    function date_set_date_format($date)
    {
    ...
    function email_send($recipients_arr, $title, $body, $from)
    {
    ...
    function geo_get_cities_at($lat, $long)
    {
    ...
    function geo_get_distance_between($lat1, $lon1, $lat2, $lon2)
    {
        $delta_lat = $lat2 - $lat1;
        $delta_lon = $lon2 - $lon1;
    ...
    function geo_get_country($ip)
    {
     ...
     public function file_upload($path, $field)
    {
    ...
    public function file_upload_multiple($path, $field)
    {
    ...
    function cut_for_tweet($str, $length=90)
    {
     ...
     */
    function get_youtube_video($url, $width='560', $height='345', $rel=0)
    {
    ...
    function detect_mobile_browser($iphone=true, $ipad=true, $android=true, $opera=true, $blackberry=true, $palm=true, $windows=true, $mobileredirect=false, $desktopredirect=false)
    {
