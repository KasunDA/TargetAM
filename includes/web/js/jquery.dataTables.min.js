...
sPageFirst:"البداية ui-corner-tl ui-corner-bl",sPagePrevious:"السابق",sPageNext:"التالى",sPageLast:"النهاية ui-corner-tr ui-corner-br",sStripOdd:"odd",sStripEven:"even",sRowEmpty:"dataTables_empty",sWrapper:"dataTables_wrapper",sFilter:"dataTables_filter",sInfo:"dataTables_info",sPaging:"dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_",sLength:"dataTables_length",sProcessing:"dataTables_processing",sSortAsc:"ui-state-default",sSortDesc:"ui-state-default",sSortable:"ui-state-default",
...
v.sPageButton+" "+v.sPageNext;x.className=v.sPageButton+" "+v.sPageLast;l.appendChild(s);l.appendChild(w);l.appendChild(y);l.appendChild(G);l.appendChild(x);i(s).bind("click.DT",function(){g.oApi._fnPageChange(g,"البداية")&&r(g)});i(w).bind("click.DT",function(){g.oApi._fnPageChange(g,"السابق")&&r(g)});i(G).bind("click.DT",function(){g.oApi._fnPageChange(g,"التالى")&&r(g)});i(x).bind("click.DT",function(){g.oApi._fnPageChange(g,"النهاية")&&r(g)});i("span",l).bind("mousedown.DT",function(){return false}).bind("selectstart.DT",
...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"عرض _MENU_ نتائج",sZeroRecords:"لا يوجد نتائج مطابقة",sEmptyTable:"<div align='right'>لا يوجد نتائج</div>",
sLoadingRecords:"Loading...",sInfo:"عرض _START_ الى _END_  من اصل _TOTAL_ نتائج",sInfoEmpty:"عرض 0 الى 0 من 0 نتائج",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"البحث :",sUrl:"",oPaginate:{sFirst:"البداية",sPrevious:"السابق",sNext:"التالى",sLast:"النهاية"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,
...
i(f).scroll(function(){if(!a.bDrawing)if(i(this).scrollTop()+i(this).height()>i(a.nTable).height()-a.oScroll.iLoadGap)if(a.fnDisplayEnd()<a.fnRecordsDisplay()){ja(a,"التالى");E(a);C(a)}});a.nScrollHead=c;a.nScrollFoot=e;return b}function Ia(a){var b=a.nScrollHead.getElementsByTagName("div")[0],c=b.getElementsByTagName("table")[0],d=a.nTable.parentNode,f,e,h,j,k,m,t,q,I=[];h=a.nTable.getElementsByTagName("thead");h.length>0&&a.nTable.removeChild(h[0]);if(a.nTFoot!==null){k=a.nTable.getElementsByTagName("tfoot");
